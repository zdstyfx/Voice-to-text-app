...
from shokztype.core.feedback import beep as _beep
...
def main() -> None:
    ...
    # 配置日志系统（统一配置）
    from shokztype.core.config import ensure_logging_dir
    ...
    if args.web:
        from shokztype.desktop import start_web_ui
        start_web_ui(config)
        return
    ...
    while True:
        ...
        if choice == "1":
            ...
            from shokztype.core.enrollment_ui import run_enrollment_menu
...
def _run_esp32_mic_mode() -> None:
    """ESP32 无线麦克风模式"""
    from shokztype.core.esp32_receiver import run_esp32_receiver
